...
Console.WriteLine("Укажите путь файла Excel (по умолчанию: \"D:\\3. Таблица ограничений параметров по подбору оборудования.xlsm\"):");
string? pathExcelFile = null;
var input = Console.ReadLine();

if (input == "")
{
    pathExcelFile = "D:\\3. Таблица ограничений параметров по подбору оборудования.xlsm";
}
...
Console.WriteLine("Укажите путь файла Json (по умолчанию: \"C:\\My ProjectCSharp\\OSUprogram2\\OSUprogram2\\Libraries\\Fans.json\"):");
...
await JsonLoader.UploadAsync(fansList, pathJsonFile);
